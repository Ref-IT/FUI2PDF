...
class ErrorHandler
{
	...
	private static function _parseInfo($info){
		...
		if (!isset($info['code'])){
			$info['code'] = 404;
			if (isset($info['controller']) && isset($info['action']) && 
				!isset($info['msg']) && $info['method'] != 'POST'){
	...
	public static function _render($info){
		...
		if (isset($info['method']) && $info['method'] == 'POST' || !isset($info['method']) && $_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	public static function _renderErrorPage($param){
        ...
        // include header
        include SYSBASE."/template/html/header.phtml";
        //include error template
        include SYSBASE."/template/html/error.phtml";
        // include footer
        include SYSBASE."/template/html/footer.phtml";
	}
}
