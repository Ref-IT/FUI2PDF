...
\setkomavar{subject}{\Large\textbf{\usekomavar{betreff}}
}
%---------------------------------------------------------------------------
...
%---------------------------------------------------------------------------
\vspace{-4mm}
\ps{\small Gegen diesen Bescheid kann innerhalb von 30 Tagen nach Zugang Widerspruch beim Studierendenrat der Technischen Universität Ilmenau schriftlich oder zur Niederschrift eingelegt werden.}
\vspace{10mm}
